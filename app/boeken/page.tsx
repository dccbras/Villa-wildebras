        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white p-8 rounded-lg shadow-md backdrop-blur-sm">
            ...
            <p className="text-center mb-8">
              Je kunt bij ons boeken via Natuurhuisje. Je kunt ook (met korting) direct bij ons boeken. We hebben niet alle beschikbaarheid open staan in Natuurhuisje. Neem contact met ons op voor een uitgebreide beschikbaarheidslijst.
            </p>
